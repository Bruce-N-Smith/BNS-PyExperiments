...
#I think this is a variable that contains a method that sends a GET requests to GitHub via the requests library functionality
r = requests.get(url)
...
#BeautifulSoup also has functionality to read through the html file for a tag, class, attribute, etc.
